...
def taxo(l):
    l.client.get("/taxonomy/objets/1", verify=False)


def classes(l):
    l.client.get("/taxonomy_classes/1", verify=False)


def classes_search(l):
    l.client.get("/taxonomy_classes", params={"taxonomy_name": "Objets", "id": 1}, verify=False)
