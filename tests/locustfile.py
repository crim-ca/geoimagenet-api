...
def add_annotation_geojson(l):
    data = {"type": "Feature", "geometry": {"type": "Polygon", "coordinates": [
        [[-13621076.051761277, 6281028.872735048], [-13621052.165189937, 6280804.33896446],
         [-13620884.959190564, 6280923.771821156], [-13621076.051761277, 6281028.872735048]]]},
     "properties": {"taxonomy_class_id": 8, "annotator_id": 1, "image_name": "My Image"}}
...
def add_annotation_xml(l):
    ...
    l.client.post("/geoserver/wfs", data=data, headers={'Content-Type': 'text/xml'}, verify=False)
...
if __name__ == '__main__':
    ...
    data = {"type": "Feature", "geometry": {"type": "Polygon", "coordinates": [
        [[-13621076.051761277, 6281028.872735048], [-13621052.165189937, 6280804.33896446],
         [-13620884.959190564, 6280923.771821156], [-13621076.051761277, 6281028.872735048]]]},
            "properties": {"taxonomy_class_id": 8, "annotator_id": 1, "image_name": "My Image"}}
    r = requests.post("https://192.168.99.201/api/v1/annotations",
                  json=data,
                  verify=False)
    print(r.json())
