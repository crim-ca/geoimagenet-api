...
def upgrade():
    ...
    op.execute('DROP INDEX IF EXISTS ix_batch_item_batch_id')
    op.execute('DROP INDEX IF EXISTS ix_batch_item_role')
    op.drop_table('batch_item')
    op.execute('DROP INDEX IF EXISTS ix_batch_created_by')
    op.drop_table('batch')
