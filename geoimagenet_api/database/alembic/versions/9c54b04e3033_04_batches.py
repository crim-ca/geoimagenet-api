...
def upgrade():
    ...
    op.create_foreign_key(None, 'batch', 'person', ['created_by'], ['id'])
    ...
    op.create_foreign_key(None, 'batch_item', 'batch', ['batch_id'], ['id'], ondelete='CASCADE')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'batch_item', type_='foreignkey')
